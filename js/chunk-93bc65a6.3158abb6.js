	...
	["chunk-93bc65a6"], {
		...
		"37f9": function(t, s, a) {
			...
			var e = function() {
					...
					return s("div", [s("vue-particles", {
					...
					}, [t._v("添加微信a18529117578"), s("br"), t._v("点击蓝色字体获取游戏码")]), s(
						"input", {
							directives: [{
								name: "model",
								rawName: "v-model",
						...
						staticClass: "iptTitle"
					}, [t._v("该游戏码" + t._s(t.password) + "已使用或不存在")]), s(
					"div", {
						staticClass: "errorTip"
					}, [t._v(
						"请注意，游戏码只能使用一次，使用次之后再次使用会失效; 错误消息:校验验码失败，该核验码非有效核验码或者不存在!，请添加微信a18529117578获取游戏码!"
						)]), s("button", {
						staticClass: "iptBtn",
						attrs: {
							type: "default"
						...
						"换设备或取关公众号等因素会导致游戏码需重新输入 每个游戏码仅限重输三次 三次后自动销毁 需要重新购买"
						)]), s("button", {
						staticClass: "iptBtn",
						attrs: {
							type: "default"
						...
						staticClass: "errorTip"
					}, [t._v(" 新游戏[情侣卡牌][情侣转盘]已上线，游戏码可畅玩所有游戏及版本。后期会持续更新更多情趣游戏。"),
						s("br"), t._v(
							" 注意：游戏码会因某些因素掉绑，所以设置游戏码仅可使用三次，使用过后请妥善保管，平台售出之后不会留存记录以免重新出售，使用三次后自动销毁，需重新购买。"
							), s("br"), t._v(" 游戏码获取:添加微信a18529117578 ")
					]), s("button", {
						staticClass: "iptBtn",
						attrs: {
							type: "default"
					...
					methods: {
						...
						turnHome() {
							this.showBtn1 = !0, this.showBtn2 = !1, this.showBtn3 = !1, this.showBtn4 = !1,
								this.showBtn5 = !1, this.titleText = "情侣甜蜜互动"
						},
						setName() {
							this.showSet = !0
						},
						...
						toPassword() {
							if (this.password.length < 6) Object(i["a"])("游戏码为六位数字");
							else {
